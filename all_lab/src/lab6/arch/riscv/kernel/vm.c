    ...
    */
    ...
    for (uint64 i = 0; i < sz; i += PGSIZE){
        ...
        if (!(pgtbl[offset[2]] & 0x1)){
            ...
            pgt_next = (uint64 *)(((pgtbl[offset[2]] & 0xfffffffffffffc00) << 2) + PA2VA_OFFSET);
            if(va == 0){
                printk("123");
            }
        }
        if (!(pgt_next[offset[1]] & 0x1)){
            ...
            pgt_nnext = (uint64 *)(((pgt_next[offset[1]] & 0xfffffffffffffc00) << 2) + PA2VA_OFFSET);
            if(va == 0){
                printk("456");
            }
        }
